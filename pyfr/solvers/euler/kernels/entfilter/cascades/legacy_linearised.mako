...
// Today's "linearised" cascade:  no nonlinear bisection, only the linearised
// rho -> p -> e limiter.  vdm/invvdm are unused by this cascade; they remain
// in the kernel signature so the matrix layout stays uniform across cascades.
...
<%pyfr:kernel name='entropyfilter' ndim='1'
    ...
    // Linearised limiter against the iso_linear_to_mean filter
