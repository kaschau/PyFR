...
% if beta != -0.5:
    ${fluid.decl('ul', 'rho, invrho, v, Y, T, p, a, cpmix, gammamix, mu, kappa, D, h, e_sp', suffix='vl')}
    fpdtype_t fvl[${ndims}][${nvars}] = {{0}};
    ${pyfr.expand('viscous_flux_add', 'ul', 'gradul', 'rhovl', 'invrhovl',
                  'vvl', 'Yvl', 'Tvl', 'cpmixvl', 'gammamixvl', 'muvl',
                  'kappavl', 'Dvl', 'hvl', 'e_spvl', 'fvl')};
% endif

% if beta != 0.5:
    ${fluid.decl('ur', 'rho, invrho, v, Y, T, p, a, cpmix, gammamix, mu, kappa, D, h, e_sp', suffix='vr')}
