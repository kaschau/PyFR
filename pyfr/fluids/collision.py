...
# Collision integral tables from Monchich and Mason

# 8
delta = np.array([0.0, 0.25, 0.50, 0.75, 1.0, 1.5, 2.0, 2.5])
...
bstar_table = np.array(
    [
        ...
        [1.10185, 1.10185, 1.10185, 1.10185, 1.10185, 1.10185, 1.10185, 1.10185],
    ]
)
...
# Polynomial fitting with an optional relative tolerance target
